(function(){
    ...
    angular.module('material.components.table', ['mdtTemplates', 'ngMaterial', 'ngMdIcons', 'pasvaz.bindonce']);
}());
(function(){
    'use strict';
